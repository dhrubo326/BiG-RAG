"""
Test retrieval from KUET Production Pipeline Knowledge Graph

This script tests how well the production pipeline KG retrieves information
...
# Same test queries as standard pipeline for fair comparison
TEST_QUERIES = [
...
async def test_production_pipeline():
    print("="*80)
    print("KUET PRODUCTION PIPELINE RETRIEVAL TEST")
    print("="*80)
    ...
    # Save results
    output_file = "D:/BiG-RAG/test_scripts/kuet_production_retrieval_results.json"
